...
5==navigator.maxTouchPoints&&(b+="&touch=1");if((f=window[U("=@42E:@?")][U("2?46DE@C~C:8:?D")])&&0<f.length){h=[];h[0]=window.location.protocol+"//"+window.location.hostname;for(l=0;l<f.length;l++)h[l+1]=f[l];f=h.reverse().join(",")}else f=null;f&&(c+="&ancChain="+encodeURIComponent(f));f=4E3;/MSIE (\d+\.\d+);/.test(navigator.userAgent)&&7>=new Number(RegExp.$1)&&(f=2E3);q.length+y.length+b.length<=f&&(b+=y,c+=q);k&&(b+="&brid="+k.ID+"&brver="+k.version+"&bridua="+k.ID_UA);r&&(b+=r);"prerender"===
window._dv_win.document.visibilityState&&(b+="&prndr=1");(h=la())&&(b+="&m1="+h);(h=ma())&&0<h.f&&(b+="&bsig="+h.f,b+="&usig="+h.s);try{var aa=V();h=0;var H=aa.document;aa==window.top&&""==H.title&&!H.querySelector("meta[charset]")&&H.querySelector('div[style*="background-image: url("]')&&(H.querySelector('script[src*="j.pubcdn.net"]')||H.querySelector('span[class="ad-close"]'))&&(h+=Math.pow(2,6));var I=h}catch(D){I=null}0<I&&(b+="&hdsig="+I);I=b;try{var F="&fcifrms="+window.top.length;window.history&&
(F+="&brh="+window.history.length);var w=V(),O=w.document;if(w==window.top){F+="&fwc="+((w.FB?1:0)+(w.twttr?2:0)+(w.outbrain?4:0)+(w._taboola?8:0));try{O.cookie&&(F+="&fcl="+O.cookie.length)}catch(D){}w.performance&&w.performance.timing&&0<w.performance.timing.domainLookupStart&&0<w.performance.timing.domainLookupEnd&&(F+="&flt="+(w.performance.timing.domainLookupEnd-w.performance.timing.domainLookupStart));O.querySelectorAll&&(F+="&fec="+O.querySelectorAll("*").length)}var x=F}catch(D){x=""}b=I+
x;x=na();b+="&vavbkt="+x.vdcd;b+="&lvvn="+x.vdcv;""!=x.err&&(b+="&dvp_idcerr="+encodeURIComponent(x.err));x="&eparams="+encodeURIComponent(U(c));return b=b.length+x.length<=f?b+x:b+"&dvf=3"}function na(){var b=[],c=function(b){e(b,null!=b.AZSD,9);e(b,b.location.hostname!=b.encodeURIComponent(b.location.hostname),10);e(b,null!=b.cascadeWindowInfo,11);e(b,null!=b._rvz,32);e(b,null!=b.FO_DOMAIN,34);e(b,null!=b.va_subid,36);e(b,b._GPL&&b._GPL.baseCDN,40);e(b,d(b,"__twb__")&&d(b,"__twb_cb_"),43);e(b,null!=
b.landingUrl&&null!=b.seList&&null!=b.parkingPPCTitleElements&&null!=b.allocation,45);e(b,d(b,"_rvz",function(b){return null!=b.publisher_subid}),46);e(b,null!=b.cacildsFunc&&null!=b.n_storesFromFs,47);e(b,b._pcg&&b._pcg.GN_UniqueId,54);e(b,d(b,"__ad_rns_")&&d(b,"_$_"),64);e(b,null!=b.APP_LABEL_NAME_FULL_UC,71);e(b,null!=b._priam_adblock,81);e(b,b.supp_ads_host&&b.supp_ads_host_overridden,82);e(b,b.uti_xdmsg_manager&&b.uti_xdmsg_manager.cb,87);e(b,b.LogBundleData&&b.addIframe,91);e(b,b.xAdsXMLHelperId||
b.xYKAffSubIdTag,95);e(b,b.__pmetag&&b.__pmetag.uid,98);e(b,b.CustomWLAdServer&&/(n\d{1,4}adserv)|(1ads|cccpmo|epommarket|epmads|adshost1)/.test(b.supp_ads_host_overridden),100)},d=function(b,c,d){for(var e in b)if(-1<e.indexOf(c)&&(!d||d(b[e])))return!0;return!1},e=function(c,d,e){d&&-1==b.indexOf(e)&&b.push((c==window.top?-1:1)*e)};try{return function(){for(var b=window,d=0;10>d&&(c(b),b!=window.top);d++)try{b.parent.document&&(b=b.parent)}catch(k){break}}(),{vdcv:28,vdcd:b.join(","),err:void 0}}catch(g){return{vdcv:28,
vdcd:"-999",err:g.message||"unknown"}}}function J(b){var c=0,d;for(d in b)b.hasOwnProperty(d)&&++c;return c}function oa(b,c){a:{var d={};try{if(b&&b.performance&&b.performance.getEntries){var e=b.performance.getEntries();for(b=0;b<e.length;b++){var g=e[b],f=g.name.match(/.*\/(.+?)\./);if(f&&f[1]){var k=f[1].replace(/\d+$/,""),h=c[k];if(h){for(var l=0;l<h.stats.length;l++){var p=h.stats[l];d[h.prefix+p.prefix]=Math.round(g[p.name])}delete c[k];if(!J(c))break}}}}var u=d;break a}catch(W){}u=void 0}if(u&&
J(u))return u}function ia(b,c,d){var e=window._dv_win.document.visibilityState;window[b]=function(b){try{var f={protocol:"https:",ssl:"1",dv_protocol:"https:"};f.serverPublicDns=b.ServerPublicDns;f.ServerPublicDns=b.ServerPublicDns;f.tagElement=c;f.redirect=d;f.impressionId=b.ImpressionID;window._dv_win.$dvbsr.tags.add(b.ImpressionID,f);if(c.dvFrmWin){var g=window._dv_win.$dvbsr;c.dvFrmWin.$uid=b.ImpressionID;g.messages&&g.messages.startSendingEvents&&g.messages.startSendingEvents(c.dvFrmWin,b.ImpressionID)}(function(){function c(){var f=
window._dv_win.document.visibilityState;"prerender"===e&&"prerender"!==f&&"unloaded"!==f&&(e=f,window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(d,c))}if("prerender"===e)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,{prndr:0});else{var d;"undefined"!==typeof window._dv_win.document.hidden?d="visibilitychange":"undefined"!==typeof window._dv_win.document.mozHidden?
d="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?d="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(d="webkitvisibilitychange");window._dv_win.document.addEventListener(d,c,!1)}})();var h=oa(window,{verifyc:{prefix:"vf",stats:[{name:"duration",prefix:"dur"}]}});h&&window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,h)}catch(l){}}}function ha(b,c){window[b]=function(b){try{v.setIsJSONPCalled(!0)}catch(e){}try{if(void 0==b.ResultID)document.write(1!=
b?c.tagsrc:c.altsrc);else switch(b.ResultID){case 1:b.Passback?document.write(decodeURIComponent(b.Passback)):document.write(c.altsrc);break;case 2:case 3:document.write(c.tagsrc)}}catch(e){}}}function Z(b,c,d){var e="";if(b&&0<b.length)for(var g=0;g<b.length;g++){var f=b[g];f.length>e.length&&null==f.match(c)&&0!=f.indexOf('src="')&&0!=f.indexOf('turl="')&&(e=f.replace(d,""))}return e}function Y(b,c,d,e,g,f){b=b.querySelectorAll(c+"["+d+'*="'+b.referrer+'"]');var k="";if(b)for(c=0;!k&&c<b.length;)k=
b[c][d].match(e),k=Z(k,g,f),c++;return k}function ka(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window.top,depth:0});for(var d,e=1,g=0;0<e&&100>g;){try{if(g++,d=c.shift(),e--,0<d.win.location.toString().length&&d.win!=b)return 0==d.win.document.referrer.length||0==d.depth?{url:d.win.location,depth:d.depth}:{url:d.win.document.referrer,depth:d.depth-1}}catch(h){}var f=d.win.frames.length;for(var k=0;k<f;k++)c.push({win:d.win.frames[k],depth:d.depth+1}),e++}return{url:"",depth:""}}catch(h){return{url:"",
depth:""}}}function U(b){new String;var c=new String,d;for(d=0;d<b.length;d++){var e=b.charAt(d);var g="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(e);0<=g&&(e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((g+47)%94));c+=e}return c}function ja(){try{if(null!=window._phantom||null!=window.callPhantom)return 99;if(document.documentElement.hasAttribute&&document.documentElement.hasAttribute("webdriver")||
null!=window.domAutomation||null!=window.domAutomationController||null!=window._WEBDRIVER_ELEM_CACHE)return 98;if(void 0!=window.opera&&void 0!=window.history.navigationMode||void 0!=window.opr&&void 0!=window.opr.addons&&"function"==typeof window.opr.addons.installExtension)return 4;if(void 0!=window.chrome&&"function"==typeof window.chrome.csi&&"function"==typeof window.chrome.loadTimes&&void 0!=document.webkitHidden&&(1==document.webkitHidden||0==document.webkitHidden))return 3;if(void 0!=window.mozInnerScreenY&&
...
void 0!=window.innerHeight?5:null}catch(d){return null}}function la(){try{var b=0,c=function(c,d){d&&32>c&&(b=(b|1<<c)>>>0)},d=function(b,c){return function(){return b.apply(c,arguments)}},e="svg"===document.documentElement.nodeName.toLowerCase(),g=function(){return"function"!==typeof document.createElement?document.createElement(arguments[0]):e?document.createElementNS.call(document,"http://www.w3.org/2000/svg",arguments[0]):document.createElement.apply(document,arguments)},f=["Moz","O","ms","Webkit"],
k=["moz","o","ms","webkit"],h={style:g("modernizr").style},l=function(b,c){function d(){f&&(delete h.style,delete h.modElem)}var e;for(e=["modernizr","tspan","samp"];!h.style&&e.length;){var f=!0;h.modElem=g(e.shift());h.style=h.modElem.style}var k=b.length;for(e=0;e<k;e++){var l=b[e];~(""+l).indexOf("-")&&(l=cssToDOM(l));if(void 0!==h.style[l])return d(),"pfx"==c?l:!0}d();return!1},p=function(b,c,e){var g=b.charAt(0).toUpperCase()+b.slice(1),h=(b+" "+f.join(g+" ")+g).split(" ");if("string"===typeof c||
"undefined"===typeof c)return l(h,c);h=(b+" "+k.join(g+" ")+g).split(" ");for(var p in h)if(h[p]in c){if(!1===e)return h[p];b=c[h[p]];return"function"===typeof b?d(b,e||c):b}return!1};c(0,!0);c(1,p("requestFileSystem",window));c(2,window.CSS?"function"==typeof window.CSS.escape:!1);c(3,p("shapeOutside","content-box",!0));return b}catch(u){return 0}}function V(){var b=window,c=0;try{for(;b.parent&&b!=b.parent&&b.parent.document&&!(b=b.parent,10<c++););}catch(d){}return b}function ma(){try{var b=V(),
c=0,d=0,e=function(b,e,f){f&&(c+=Math.pow(2,b),d+=Math.pow(2,e))},g=b.document;e(14,0,b.playerInstance&&g.querySelector('script[src*="ads-player.com"]'));e(14,1,(b.CustomWLAdServer||b.DbcbdConfig)&&(a=g.querySelector('p[class="footerCopyright"]'),a&&a.textContent.match(/ MangaLife 2016/)));e(15,2,b.zpz&&b.zpz.createPlayer);e(15,3,b.vdApp&&b.vdApp.createPlayer);e(15,4,g.querySelector('body>div[class="z-z-z"]'));e(16,5,b.xy_checksum&&b.place_player&&(b.logjwonready&&b.logContentPauseRequested||b.jwplayer));
e(17,6,b==b.top&&""==g.title?(a=g.querySelector('body>object[id="player"]'),a&&a.data&&1<a.data.indexOf("jwplayer")&&"visibility: visible;"==a.getAttribute("style")):!1);e(17,7,g.querySelector('script[src*="sitewebvideo.com"]'));e(17,8,b.InitPage&&b.cef&&b.InitAd);e(17,9,b==b.top&&""==g.title?(a=g.querySelector("body>#player"),null!=a&&null!=(null!=a.querySelector('div[id*="opti-ad"]')||a.querySelector('iframe[src="about:blank"]'))):!1);e(17,10,b==b.top&&""==g.title&&b.InitAdPlayer?(a=g.querySelector('body>div[id="kt_player"]'),
null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);e(17,11,null!=b.clickplayer&&null!=b.checkRdy2);e(19,12,b.instance&&b.inject&&g.querySelector('path[id="cp-search-0"]'));e(20,13,function(){try{if(b.top==b&&0<b.document.getElementsByClassName("asu").length)for(var c=b.document.styleSheets,d=0;d<c.length;d++)for(var e=b.document.styleSheets[d].cssRules,f=0;f<e.length;f++)if("div.kk"==e[f].selectorText||"div.asu"==e[f].selectorText)return!0}catch(q){}}());a:{try{var f=null!=g.querySelector('div[id="kt_player"][hiegth]');
break a}catch(u){}f=void 0}e(21,14,f);a:{try{var k=b.top==b&&null!=b.document.querySelector('div[id="asu"][class="kk"]');break a}catch(u){}k=void 0}e(22,15,k);a:{try{var h=g.querySelector('object[data*="/VPAIDFlash.swf"]')&&g.querySelector('object[id*="vpaid_video_flash_tester_el"]')&&g.querySelector('div[id*="desktopSubModal"]');break a}catch(u){}h=void 0}e(25,16,h);var l=navigator.userAgent;if(l&&-1<l.indexOf("Android")&&-1<l.indexOf(" wv)")&&b==window.top){var p=g.querySelector('img[src*="dealsneartome.com"]')||
(b.__cads__?!0:!1)||0<g.querySelectorAll('img[src*="/tracker?tag="]').length;e(28,17,p||!1)}return{f:c,s:d}}catch(u){return null}}var m=this,v=function(){function b(b,c,d){var f=[];c&&k.forEach(function(b){var d=dv_GetParam(c,b);""!==d&&null!==d&&f.push(["dvp_"+b,d].join("="))});f.push(["dvp_scln",c&&c.length||0].join("="));K(g,e,b,d,f.join("&"))}function c(c){var d="AdRenderedUponVerifyFailure";if(m&&m.redirect&&m.redirect.tagsrc)try{document.write(m.redirect.tagsrc)}catch(u){d+="__DocumentWrite__"+
encodeURIComponent(u.message)}else m?m.redirect?m.redirect.tagsrc||(d+="__HandlerRedirectTagsrc__Undefined"):d+="__HandlerRedirect__Undefined":d+="__Handler__Undefined";b(d,c,!1)}var d=!1,e,g,f=[m.constructor&&m.constructor.name||"UKBS","__",dv_GetRnd()].join(""),k=["ctx","cmp","plc","sid"],h={onResponse:function(e){d||(b("VerifyCallbackFailed",e,!0),c(e))},onError:function(d){b("VerifyFailedToLoad",d,!0);c(d)}};h.reportError=b;h.isJSONPCalled=d;window&&(window._dv_win=window._dv_win||{},window._dv_win[f]=
{globalScopeVerifyCErrorHandler:h});return{setVersionData:function(b,c){g=b;e=c},setIsJSONPCalled:function(b){d=b},getIsJSONPCalled:function(){return d},onLoad:dv_onResponse,onError:dv_onError_evaluation,uniqueKey:f}}();this.createRequest=function(){window.performance&&window.performance.mark&&window.performance.mark("dv_create_req_start");var b=!1,c=window,d=0,e=!1;try{for(dv_i=0;10>=dv_i;dv_i++)if(null!=c.parent&&c.parent!=c)if(0<c.parent.location.toString().length)c=c.parent,d++,b=!0;else{b=!1;
break}else{0==dv_i&&(b=!0);break}}catch(p){b=!1}a:{try{var g=c.$sf;break a}catch(p){}g=void 0}var f=c.location&&c.location.ancestorOrigins,k=f&&f[f.length-1];if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;a:{try{var h=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(p){}h=void 0}if(h&&(!f||0==h.indexOf(k))){b=h;var l=!0}e=!0}if(!window._dv_win.bsredirect5ScriptsInternal||!window._dv_win.bsredirect5Processed||0==window._dv_win.bsredirect5ScriptsInternal.length)return{isSev1:!1,
url:null};this.dv_script_obj=f=ca();f=this.dv_script=f.script;if((k=f.src.replace(/^.+?callback=(.+?)(&|$)/,"$1"))&&(this.redirect=eval(k+"()"))&&!this.redirect.done){this.redirect.done=!0;if(ba(this.redirect))return{isSev1:!0};c=M(this.redirect,b,c,d,e,f&&f.parentElement&&f.parentElement.tagName&&"HEAD"===f.parentElement.tagName,f,l,g);c+="&"+this.getVersionParamName()+"="+this.getVersion();window.performance&&window.performance.mark&&window.performance.measure&&window.performance.getEntriesByName&&
...
try{var c=da(this.dv_script_obj&&this.dv_script_obj.injScripts),d=document.createElement("iframe");d.name=d.id="iframe_"+dv_GetRnd();d.width=0;d.height=0;d.id=void 0;d.style.display="none";d.src="about:blank";d.id=d.name;var e=d.id.replace("iframe_","");d.setAttribute&&d.setAttribute("data-dv-frm",e);L(d,this.dv_script);if(this.dv_script){var g=this.dv_script;a:{b=null;try{if(b=d.contentWindow){var f=b;break a}}catch(l){}try{if(b=window._dv_win.frames&&window._dv_win.frames[d.name]){f=b;break a}}catch(l){}f=
null}g.dvFrmWin=f}var k=ea(d);if(k)k.open(),k.write(c);else{try{document.domain=document.domain}catch(l){}var h=encodeURIComponent(c.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));d.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+h+"');})()"}}catch(l){K(this.getVersionParamName(),this.getVersion(),"DvFrame: "+encodeURIComponent(l),!1)}return!0};window.debugScript&&(!window.minDebugVersion||10>=window.minDebugVersion)&&(window.DvVerify=M,
window.createRequest=this.createRequest);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"103"}};
